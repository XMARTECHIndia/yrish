...
List<UpcomingModel> upcomingModelFromJson(String str) => List<UpcomingModel>.from(json.decode(str).map((x) => UpcomingModel.fromJson(x)));

String upcomingModelToJson(List<UpcomingModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
