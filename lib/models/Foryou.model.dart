...
List<ForyouModel> foryouModelFromJson(String str) => List<ForyouModel>.from(json.decode(str).map((x) => ForyouModel.fromJson(x)));

String foryouModelToJson(List<ForyouModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
