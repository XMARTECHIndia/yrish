...
//
//     final arrivalModel = arrivalModelFromJson(jsonString);

import 'dart:convert';

List<ArrivalModel> arrivalModelFromJson(String str) => List<ArrivalModel>.from(json.decode(str).map((x) => ArrivalModel.fromJson(x)));

String arrivalModelToJson(List<ArrivalModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
